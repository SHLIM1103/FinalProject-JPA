...
@NamedQuery(name = "Board.findByBrdTitle", query = "select b from Board b where b.brdTitle like :brdTitle")
public class Board {
   ...
   @Column(name="brd_count") @GeneratedValue(strategy = GenerationType.AUTO) private int brdCount;
