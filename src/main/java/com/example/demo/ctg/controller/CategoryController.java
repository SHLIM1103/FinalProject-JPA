...
public class CategoryController extends AbstractController<Category> {
	...
	@PostMapping("/save")
	public ResponseEntity<Integer> save(Category t) {
		return ResponseEntity.ok(service.save(t));
	}

	@DeleteMapping("/delete")
	public ResponseEntity<Integer> delete(Category t) {
	...
	@GetMapping("/one/{id}")
	public ResponseEntity<Category> getOne(int id) {
		return ResponseEntity.ok(service.getOne(id));
	}

	@GetMapping("/find/{id}")
	public ResponseEntity<Optional<Category>> findById(int id) {
