...
public class QPayment extends EntityPathBase<Payment> {
    ...
    public final com.example.demo.crt.domain.QCart cart;
    ...
    public QPayment(Class<? extends Payment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.cart = inits.isInitialized("cart") ? new com.example.demo.crt.domain.QCart(forProperty("cart"), inits.get("cart")) : null;
